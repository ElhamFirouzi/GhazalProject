            ...
            <Container>
                ...
                <Content>
                    <View style={styles.topheader}>
                        ...
                        <Body>
                            <Title style={styles.ghazal}>کارجویان </Title>
                        </Body>
                        <Right >
                                ...
                                <View key={index}>
                                    <View style={styles.boxsmall}>
                                        <View>
                                            ...
                                            <Text style={styles.PharmacyOther}> <Icon name="graduation-cap" size={20} color="#858585" /> {"  "}{item.Educational} </Text>
                                            <Text style={styles.PharmacyOther}> <Icon name="calendar-check-o" size={20} color="#858585"  /> {"  "}{item.  Date_of_birth} </Text>
                                            <Text style={styles.PharmacyOther}> <Icon name="calendar" size={20} color="#858585" />{"  "}{item.Date} </Text>
                                            <Text style={styles.PharmacyOther}><Icon name="female" size={20} color="#858585"  />|<Icon name="male" size={20} color="#858585"  /> 
                                            {"  "}{item.gender} </Text>
                                                ...
                                                <Text style={{marginLeft:10,}}>
                                                    ...
                                                    <Modal isVisible={this.state.isModalVisible} animationType='slide' >
                                                        <View style={{ width: 350, height: 300, backgroundColor: '#FFFFFF' }}>
                                                            <Text style={{ color: '#212529', fontFamily: 'IRANSans(FaNum)', marginBottom: 30, fontSize: 22,paddingRight:20 }} >ارسال پیام!</Text>
