...
class PharmaceuticalDetails extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            ProvinceText: '',
            ...
            Global: [
                {
                    ...
                    PahrmacyName: "  شرکت :کمپانی",
                  
                    location: 'تهران نیاوران ',
                    Hour: ' تلفن تماس :09127381725',

                    gender: 'جنسیت :فرقی_نمیکند'
                },
                ...
                <Content>
                    ...
                    <View style={styles.box}>
                        ...
                        <View style={{ flex: 1, marginTop: 10 }}>
                            <Text style={styles.ShiftTitle}>جنسیت:</Text>
                        ...
                        <View style={styles.boxsmall}>
                            ...
                            <Text style={styles.PharmacyOther}> <Icon name="map-marker" size={20} color="#858585" /> {item.location} </Text>
                                            ...
                                            <Text style={styles.PharmacyOther}> <Icon name="phone-square" size={20} color="#858585" />{item.Hour} </Text>
